...
echo "------------------------------------------------------------"
python -m scripts.train_unified --schema=tsconfig-base --tokenizer=tct --model_size=small --data_root=/workspace/data
echo
...
echo "      Context: 2048, Vocab: 257, Epochs: 150"
echo "------------------------------------------------------------"
python -m scripts.train_unified --schema=eslintrc-base --tokenizer=tct --model_size=small --data_root=/workspace/data
echo
...
echo "------------------------------------------------------------"
python -m scripts.train_unified --schema=kubernetes --tokenizer=tct --model_size=small --data_root=/workspace/data
echo
