...
# 2. Submits all training jobs (which will extract data if needed)
#
# Usage:
...
echo ">>> Step 1: Cleanup checkpoints and logs"
echo
...
# =============================================================================
# Step 2: Submit all (will check/extract data, then submit jobs)
# =============================================================================
