...
SCHEMAS = {
    "kubernetes": SchemaConfig(
        name="kubernetes",
        merge_table="bpe-merges/kubernetes-utf8-bpe.json",
        tct_module_name="tct_kubernetes_bpe20k",
        context_size=256,
    ...
    "eslintrc": SchemaConfig(
        name="eslintrc",
        merge_table="bpe-merges/eslintrc-utf8-bpe-500.json",
        tct_module_name="tct_eslintrc_bpe500",
        context_size=256,
    ...
    "tsconfig": SchemaConfig(
        name="tsconfig",
        merge_table="bpe-merges/tsconfig-utf8-base-matched.json",
        tct_module_name="tct_tsconfig_base",
        context_size=256,
