...
dropout = 0.1           # default 0.1 prevents overfitting, or 0.0-0.5
...
save_every_pct = None   # None => auto (2% on RunPod, 10% otherwise), or override
...
if save_every_pct is None:
    save_every_pct = 2 if is_runpod else 10
